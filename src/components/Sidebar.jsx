...
const NavLinks=({handleClick}) => {
  return <div className='mt-10'>
    {links.map((item, i) =>
      <NavLink key={i} to={item.to} onClick={() => handleClick && handleClick()} className="flex flex-row justify-start items-center my-8 text-sm font-medium text-gray-400 hover:text-cyan-400">
...
const Sidebar = () => {
  ...
  return <>
    <div className='md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#13111b]'>
